        ...
        <Container>
            <Row>
                ...
                <Col lg={4} sm={6}>
                    ...
                    <BsBoxFill />
                    <h6>Figma to HTML</h6>
                    <p>Figma to HTML involves converting designs created in Figma, a web design tool, into HTML code for web development. This process ensures that designs are translated accurately into functional web pages and apps.</p>
                    </div>
                </Col>
                <Col lg={4} sm={6}>
                    <div className="card_one">
                ...
                <Col lg={4} sm={6}>
                    ...
                    <p>Web customization in front-end web development involves tailoring website appearance and functionality to meet specific client needs through HTML, CSS, JavaScript, ensuring unique and personalized user experiences.</p>
                    </div>
                </Col>
            </Row>
        </Container>
